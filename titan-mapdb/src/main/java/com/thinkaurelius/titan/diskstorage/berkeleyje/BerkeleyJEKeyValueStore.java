...
public class BerkeleyJEKeyValueStore implements OrderedKeyValueStore {
    ...
    public BerkeleyJEKeyValueStore(String n, BerkeleyJEStoreManager m) {
        name = n;
        manager = m;
        isOpen = true;
    }
    ...
    public StaticBuffer get(StaticBuffer key, StoreTransaction txh) throws BackendException {
        ...
        return ((BerkeleyJETx)txh).get(name,key);
    }
    ...
    public RecordIterator<KeyValueEntry> getSlice(KVQuery query, StoreTransaction txh) throws BackendException {
        ...
        try {
            final List<KeyValueEntry> result = ((BerkeleyJETx)txh).getSlice(name,selector,keyStart,keyEnd);
...
//            log.trace("db={}, op=getSlice, tx={}, resultcount={}", name, txh, result.size(), new Throwable("getSlice trace"));
    ...
    public void insert(StaticBuffer key, StaticBuffer value, StoreTransaction txh, boolean allowOverwrite) throws BackendException {
        try {
            ...
            ((BerkeleyJETx)txh).insert(name,key,value, allowOverwrite);
    ...
    public void delete(StaticBuffer key, StoreTransaction txh) throws BackendException {
        ...
        try {
            ...
            ((BerkeleyJETx)txh).delete(name, key);
        } catch (DBException e) {
            throw new PermanentBackendException(e);
        }
    }
