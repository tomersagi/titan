...
//    protected Environment environment;
    ...
    public BerkeleyJEStoreManager(Configuration configuration) throws BackendException {
        ...
        DBMaker.Maker maker =  DBMaker.fileDB(new File(directory, "titanBackEnd.mapdb"))
                ...
                .serializerClassLoader(BerkeleyJEStoreManager.class.getClassLoader());
...
//                tx = environment.beginTransaction(null, txnConfig);
            ...
            BerkeleyJETx btx = new BerkeleyJETx(db, commitLock, txCfg);
    ...
    public BerkeleyJEKeyValueStore openDatabase(String name) throws BackendException {
        ...
        try {
            ...
            BerkeleyJEKeyValueStore store = new BerkeleyJEKeyValueStore(name, this);
